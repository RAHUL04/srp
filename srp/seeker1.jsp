...
function search(){
	...
	ajaxRequest.open("GET", "searchservice.jsp" + queryString, true);
	...
	ajaxRequest.open("GET", "comment.jsp" , true);
	ajaxRequest.send(null);
	}
	function stars(){
...
for (var i = 0, length = radios.length; i < length; i++) {
	...
	var queryString = "?name=" + name + "&rate=" + rate ;
	ajaxRequest.open("GET", "rate.jsp" + queryString, true);
	ajaxRequest.send(null);
...
<div id="container" class="width">
  ...
  <strong>SEARCH SERVICE:<input type="text" id="search" onKeyup=search()></strong>
 <br>
 <br>
 <br>
