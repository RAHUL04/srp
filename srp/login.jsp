...
<div id="container" class="width">
  ...
  <input id="search" name="search" type="text" placeholder="What're you are looking for ?" onKeyup=search()><input id="search_submit" value="Rechercher" type="submit">
<br>
<br>
<br>
<br>
<br>
<br>
Mail-id:<input type="text" id='age' value="mail-id"/>
</div>
...
<input type='button' onclick='ajaxFunction()' value="LOG-IN"  />
        ...
        <div id="bo" style="width: 200px; height: 1em; overflow: hidden;"></div> 
</html>
