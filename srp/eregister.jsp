...
occupation=request.getParameter("loc");
...
String query = "INSERT INTO expert (name,password,occupation,experience,address,phone,rating) VALUES ('"+name+"','"+password+"','"+occupation+"','"+exp+"','"+address+"','"+phone+"','"+rating+"');";
